...
var onRun = function (context) {    
    ...
    var name = Utilz.nativeUI.displayInput(doc, "Enter layer name to select", "Rectangle");
    ...
    Utilz.helper.selectLayers(nameLayers);    
    doc.showMessage(total+" layer(s) named "+name+" selected");
}